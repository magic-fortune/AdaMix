...
def Inference_model1(FLAGS):
    ...
    snapshot_path = "./model/BCP/ACDC_{}_{}_m_{}_lam_{}_labeled_exange_fea_out_final_have_ori_cps_loss_RE/self_train".format(FLAGS.exp, FLAGS.labeled_num, FLAGS.m, FLAGS.lam)
