...
parser.add_argument('--root_path', type=str,
                    default='../data/MMHWS/', help='Name of Experiment')
...
def calculate_metric_percase(pred, gt):
    ...
    return dice, jc, hd95, asd, precision, recall
...
def Inference_model1(FLAGS):
    ...
    save_mode_path = os.path.join(snapshot_path, 'model1_iter_22000_dice_88.4031.pth')
    ...
    for case in tqdm(image_list):
        first_metric, second_metric, third_metric, four_metric, fifth_metric, sixth_metric, seventh_metric = test_single_volume(case, net, FLAGS)
    ...
    avg_metric = [first_total / len(image_list), second_total / len(image_list), third_total / len(image_list), four_total / len(image_list), fifth_total / len(image_list), sixth_total / len(image_list), seventh_total / len(image_list)]
    # avg_metric = [first_total / len(image_list), second_total / len(image_list), third_total / len(image_list)]
    average = (avg_metric[0]+avg_metric[1]+avg_metric[2]+ avg_metric[3] + avg_metric[4]+avg_metric[5]+avg_metric[6])/7
    print(avg_metric)
    print(average)
